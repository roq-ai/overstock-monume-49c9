...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'customer-service-representative', 'payment-processor', 'inventory-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Monument', path: '/monuments', entity: 'monument', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Payment', path: '/payments', entity: 'payment', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
